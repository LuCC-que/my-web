import classes from "./SkillDropDown.module.css";
const SkillDropDown = (props) => {
  ...
  return (
    <button onClick={onClickHandler} className={`${classes["skill-button"]}`}>
      <svg
      ...
      <svg
        className={`${classes.chevron} ${props.dropDown && classes.collect}`}
        width="16"
        height="9"
        viewBox="0 0 16 9"
        fill="none"
